...
class XTCPageViewController: XTCBaseViewController {
    
    
    var pageStyle: XTCPageStyle!
    ...
    convenience init(titles: [String] = [], vcs: [UIViewController] = [], pageStyle: XTCPageStyle = .none) {
        self.init()
        self.titles = titles
        self.vcs = vcs
...
extension XTCPageViewController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
